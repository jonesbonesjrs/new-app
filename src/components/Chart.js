...
class Chart extends React.Component {
  ...
  change_to_Epidemic() {
    ...
    if (this.state.sun === sun_data) {
      this.setState(state => ({ data: epi_labels }));
    } else if (this.state.sun === dalton_sun) {
      this.setState(state => ({ data: dalton_epi }));
    } else if (this.state.sun === maunder_sun) {
      this.setState(state => ({ data: maunder_epi }));
    } else if (this.state.sun === modern_sun) {
      this.setState(state => ({ data: modern_epi }));
    }
  }
  ...
  change_to_Famine() {
    ...
    if (this.state.sun === sun_data) {
      this.setState(state => ({ data: fam_labels }));
    } else if (this.state.sun === dalton_sun) {
      this.setState(state => ({ data: dalton_fam }));
    } else if (this.state.sun === maunder_sun) {
      this.setState(state => ({ data: maunder_fam }));
    } else if (this.state.sun === modern_sun) {
      this.setState(state => ({ data: modern_fam }));
    }
  }
  change_to_None() {
    if (this.state.sun === sun_data) {
